...
| P2-PWA-tech | Phase 2 PWA — tech/architecture phase (framework, voice engine, terminal-on-mobile, PWA infra) → then `writing-plans` → build | Phase 2 PWA ships | **in flight** → [`docs/arch/pwa/`](arch/pwa/README.md) (v0.1: L0–L3 + L5 authored; L4 `feature-modules.md` + L6 `cross-cutting.md` stubbed, committed 2026-07-02). Resolves the [`server-touchpoints.md`](design/pwa/server-touchpoints.md) additive surface into concrete protocol/REST changes (filing NDs) |
