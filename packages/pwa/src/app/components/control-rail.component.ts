...
//
// Arrow sequences are the ND-48 normal cursor-mode stopgap (ESC [ A/B); DECCKM
...
export const CONTROL_RAIL_KEYS: RailKey[] = [
  ...
  { label: '↑', aria: 'Up', bytes: [0x1b, 0x5b, 0x41] }, // ESC [ A (ND-48 stopgap)
  { label: '↓', aria: 'Down', bytes: [0x1b, 0x5b, 0x42] }, // ESC [ B (ND-48 stopgap)
