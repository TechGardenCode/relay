...
// Per D-13 + ND-47: the pairing artifact is `relay://pair?url=<server>&token=<bearer>`.
...
export class AuthService {
  // Per data-layer.md §2 + ND-47: bearer + server URL live in localStorage, read
  ...
  // Per ND-47: REST/WS base origin; null ⇒ same-origin fallback.
  ...
  // Per D-13 + ND-47: extract token AND server url from the pair deep link (or
