...
- `spawn.json` is validated against [`SpawnRecordSchema`](../../../../packages/protocol/src/spawn-record.ts) (per [ND-12](../../../../docs/decisions/ND-12-spawn-json-schema-location.md)) **before** the write; a malformed record fails loud rather than landing on disk.
